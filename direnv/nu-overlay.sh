...
let nu_direnv_overlay_env_before = (
  $env
  | reject --optional PWD FILE_PWD CURRENT_FILE config LAST_EXIT_CODE NU_DIRENV_OVERLAY_ACTIVE NU_DIRENV_OVERLAY_EXPORTS NU_DIRENV_OVERLAY_ENV_NAMES NU_DIRENV_OVERLAY_ENV_BEFORE NU_DIRENV_OVERLAY_ENV_BEFORE_NAMES NU_DIRENV_OVERLAY_APPLY_LOADED NU_DIRENV_OVERLAY_APPLY_PWD
